...
<body>
    <form id="form1" runat="server">
        <div class="dashboard-shell">
            <div class="topbar">
                <div class="brand">Gadget Hub Admin</div>
                <div class="admin-info">
                    <asp:Label ID="lblAdminEmail" runat="server" CssClass="admin-email" Text="admin@gadgethub.lk"></asp:Label>
            ...
            <div class="layout">
                <nav class="sidebar">
                    ...
                    <div class="nav-links">
                        <a class="nav-link" href="UsersSection.aspx" target="contentFrame">Users</a>
                        ...
                        <a class="nav-link" href="ProductsSection.aspx" target="contentFrame">Products</a>
                        <a class="nav-link" href="ContactsSection.aspx" target="contentFrame">Contact Messages</a>
                    </div>
                </nav>
